...
<%@page import="com.kosta.k153p2.dto.ItemInfo"%>
<%@page import="java.util.List"%>
<%@page import="com.kosta.k153p2.dao.ItemInfoDao"%>
...
*/
	...
	for (int i = 0; i < returnList.size(); i++) {
		...
		jsonObj.put("item_photo", returnList.get(i).getItem_photo());
		//System.out.println(returnList.get(i).getItem_photo());
		jArray.add(jsonObj);
	}
